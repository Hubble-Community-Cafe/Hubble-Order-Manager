defmodule RemovemeWeb.UserAuth do
  use RemovemeWeb, :verified_routes

  import Plug.Conn
  import Phoenix.Controller

  # alias Removeme.Accounts
  # alias Removeme.Accounts.Scope
  ...
  # @max_cookie_age_in_days 14
  # @remember_me_cookie "_removeme_web_user_remember_me"
  # @remember_me_options [
  #   sign: true,
  #   max_age: @max_cookie_age_in_days * 24 * 60 * 60,
  #   same_site: "Lax"
  ...
  #     RemovemeWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
  #   end
  ...
  #     RemovemeWeb.Endpoint.broadcast(user_session_topic(token), "disconnect", %{})
  #   end)
  # end
  ...
  #     defmodule RemovemeWeb.PageLive do
  #       use RemovemeWeb, :live_view

  #       on_mount {RemovemeWeb.UserAuth, :mount_current_scope}
  #       ...
  #     end

  # Or use the `live_session` of your router to invoke the on_mount callback:

  #     live_session :authenticated, on_mount: [{RemovemeWeb.UserAuth, :require_authenticated}] do
