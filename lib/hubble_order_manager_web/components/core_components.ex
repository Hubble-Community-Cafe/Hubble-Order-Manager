defmodule RemovemeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RemovemeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RemovemeWeb.Gettext, "errors", msg, opts)
    end
  end
